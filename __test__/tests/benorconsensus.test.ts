...
describe("Ben-Or decentralized consensus algorithm", () => {
  ...
  describe("Testing Ben-Or implementation - 16 pt", () => {
    ...
    test("Hidden test - Finality is reached - Unanimous Agreement - 2 pt", async () => {
      const faultyArray = [true, false, false, false, false];
      const initialValues: Value[] = [0, 1, 1, 1, 1];
      const _servers = await launchNetwork(
        faultyArray.length,
        faultyArray.filter((el) => el === true).length,
        initialValues,
    ...
    test("Hidden test - Simple Majority - Unanimous Agreement - 1 pt", async () => {
      const faultyArray = [true, false, false, false, false];
      const initialValues: Value[] = [0, 1, 1, 1, 0];
      const _servers = await launchNetwork(
        faultyArray.length,
        faultyArray.filter((el) => el === true).length,
        initialValues,
    ...
    test("Hidden test - Fault Tolerance Threshold - Unanimous Agreement - 1 pt", async () => {
      const faultyArray = [true, true, false, false, false];
      const initialValues: Value[] = [0, 0, 1, 1, 1];
      const _servers = await launchNetwork(
        faultyArray.length,
        faultyArray.filter((el) => el === true).length,
        initialValues,
    ...
    test("Hidden test - Fault Tolerance Threshold - Exceeding Fault Tolerance - 1 pt", async () => {
      const faultyArray = [true, true, true, false, false, false];
      const initialValues: Value[] = [0, 1, 0, 1, 0, 1];
      const _servers = await launchNetwork(
        faultyArray.length,
        faultyArray.filter((el) => el === true).length,
        initialValues,
    ...
    test("Hidden test - Fault Tolerance Threshold - No Faulty Nodes - 1 pt", async () => {
      const faultyArray = [false, false, false, false];
      const initialValues: Value[] = [1, 0, 1, 0];
      const _servers = await launchNetwork(
        faultyArray.length,
        faultyArray.filter((el) => el === true).length,
        initialValues,
    ...
    test("Hidden test - Fault Tolerance Threshold - Randomized - 1 pt", async () => {
      const faultyArray = [true, false, false, false, true];
      const _initialValues: Value[] = new Array(5).fill(0);
      const initialValues = _initialValues.map(
        (el) => generateRandomValue() as Value
      );
      const _servers = await launchNetwork(
        faultyArray.length,
    ...
    test("Hidden test - Fault Tolerance Threshold - One node - 1 pt", async () => {
      const faultyArray = [false];
    ...
    test("Hidden Test - 1 pt", async () => {
      const faultyArray = [true, false, false];
      const initialValues: Value[] = [0, 1, 0];
      const _servers = await launchNetwork(
        faultyArray.length,
        faultyArray.filter((el) => el === true).length,
        initialValues,
